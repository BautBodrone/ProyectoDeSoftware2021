      ...
      <div class="col" style="display:flex">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <router-link class="nav-link active" to="/denuncias" aria-current="page">Ir</router-link>
          </div>
        </div>
      </div>
      <div class="col" style="display:flex">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <router-link class="nav-link active" to="/zonas-inundables" aria-current="page">Ir</router-link>
          </div>
        </div>
      </div>
      <div class="col" style="display:flex">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <router-link class="nav-link active" to="/puntos-de-encuentro" aria-current="page">Ir</router-link>
          </div>
        </div>
      </div>
      <div class="col" style="display:flex">
